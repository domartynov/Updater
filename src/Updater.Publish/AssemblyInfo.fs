...
[<assembly: AssemblyInformationalVersionAttribute("0.2.18")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "0.2.18"
    let [<Literal>] AssemblyFileVersion = "0.2.18"
    let [<Literal>] AssemblyInformationalVersion = "0.2.18"
